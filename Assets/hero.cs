...
public class hero : MonoBehaviour
{
    ...
    private IEnumerator FallHit()
    {
        ...
        //rb.velocity = new Vector2(-transform.localScale.y * dashindPower, 0f);
        if (isGrounded)
        {
            Debug.Log("ionground");
            isfallhit = false;
            ...
            Collider2D[] hitEnemies = Physics2D.OverlapCircleAll(fallhitpoin.position, attackRange, enemyLayers);
